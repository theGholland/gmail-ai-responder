...
def madlibs():
    ...
    prompt = (
        ...
        "Identify the tone of the message, infer the type of person they are using Myers Briggs personailty types, listed under 'Tone:' and 'Personality:'. Identify the type of poker play they embody; 1. Loose and Passive, 2. Loose and Aggressive, 3. Tight and Aggressive, or 4. Tight and Passive; and list it under "Feeling:". Also list the type of poker play that comes before and after what was listed under "Feeling" - if they are feeling like a 4, list 3 and 1. Do this under "Response Types:". Determine their explicitly stated wants, and determine their implicit needs based on how they speak. List these under 'Needs:' as bullet points."
